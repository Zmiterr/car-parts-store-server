...
const getPart = async (id) =>
  ...
  // return partById;
  ({
    rows: `getPart mock executed. id ${id}`,
  });
const createPart = async (part) =>
  ...
  // return newPart;
  ({
    rows: `createPart mock executed. part ${part}`,
  });
const updatePart = async (id, updateData) =>
  ...
  // return updatedPart;
  ({
    rows: `updatePart mock executed. id ${id}. updateData ${updateData}`,
  });
const deletePart = async (id) =>
  ...
  // return id;
  ({
    rows: `deletePart mock executed. id ${id}`,
  });
